...
public partial class MainWindow : FluentWindow
{
    ...
    private void OnSessionOpenRequested(object? sender, NetSniffer.Core.Sessions.SessionInfo session)
    {
        string capture = System.IO.Path.Combine(session.Directory, NetSniffer.Core.Sessions.SessionStore.CaptureFileName);
        string requests = System.IO.Path.Combine(session.Directory, NetSniffer.Core.Sessions.SessionStore.RequestsFileName);
